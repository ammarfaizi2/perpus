    ...
    ?>
            <tr>
                ...
                <?php echo 
                    ...
                    <a href="'.base_url().'admin/Kembali/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="detail Pinjam"><i class="fa fa-share"></i></a>
                </td>
            </tr>';?>
<?php
    }
